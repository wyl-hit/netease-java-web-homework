  ...
  <body>
		...
		<div class="row">
			...
			<div class="col-sm-10  col-md-10 col-sm-offset-1 col-md-offset-1">
				...
				<div class="row">
					...
					<button type="button" class="btn btn-danger btn-lg col-lg-3 col-md-3 col-sm-3" onclick="window.history.go(-1);" style="float:left;margin-left:10px;">退出</button>
					<button type="button" class="btn btn-danger btn-lg col-lg-3 col-md-3 col-sm-3" onclick="confirmPre()" style="float:left;margin-left:10px;">确认购买</button>
				</div>
			</div>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		function addToShoppingRecordsPre(productsId,productsCounts) {
			...
			layer.confirm('前往(财务)订单页面？', {icon: 1, title:'购买成功',btn:['前往订单','继续购买']},
					function(){
