...
<html lang="zh-CN">
        ...
        <div class="row">
            ...
            <div class="col-sm-3 col-md-2 sidebar sidebar-1">
                <ul class="nav nav-sidebar">
                    <li class="list-group-item-diy"><a href="#section1">查看所有商品</a></li>
                    <li class="list-group-item-diy"><a href="#section2">发布商品</a></li>
                </ul>
            </div>
            <!-- 控制内容 -->
                        ...
                        <div  class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    ...
                                    <p class="help-block">上传的图片大小显示为280*260大小</p>
                                </div>
  ...
  <script type="text/javascript">
      ...
      function fileUpload(productId) {
          ...
          $.ajaxFileUpload({
              url:'${cp}/uploadFile?id='+productId,
              secureuri:false ,
